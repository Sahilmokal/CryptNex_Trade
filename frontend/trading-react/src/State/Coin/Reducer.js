...
const coinReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case SEARCH_COIN_SUCCESS:
      return {
        ...state,
        searchCoinList: action.payload.coins ?? action.payload,
        loading: false,
      };
...
case FETCH_TOP_LOSERS_REQUEST:
  console.log("🟡 REDUCER: FETCH_TOP_LOSERS_REQUEST");
  return {
    ...state,
    loading: true,
  };
...
case FETCH_TOP_LOSERS_SUCCESS:
  console.log("🟢 REDUCER: FETCH_TOP_LOSERS_SUCCESS", action.payload);
  return {
    ...state,
...
case FETCH_TOP_LOSERS_FAILURE:
  console.log("🔴 REDUCER: FETCH_TOP_LOSERS_FAILURE", action.payload);
  return {
    ...state,
    loading: false,
    error: action.payload,
